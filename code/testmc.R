...
list_df<-function(x){
  ...
  um_df=do.call(rbind, lapply(um_l, data.frame, stringsAsFactors=FALSE))
  doi_df=do.call(rbind, lapply(doi_l, data.frame, stringsAsFactors=FALSE))
  return(list(um_df,doi_df))
}
