...
reser1<-readRDS(file = "outs/simest/genericER/res_erq1.rds")
reser2<-readRDS(file = "outs/simest/genericER/res_erq2.rds")
reser3<-readRDS(file = "outs/simest/genericER/res_erq3.rds")
reser4<-readRDS(file = "outs/simest/genericER/res_erq4.rds")

resertmb<-rbind(reser1,reser2,reser3,reser4)
...
reser<-rbind(resertmb)#,reserstan)

#res<-resstan
reser$parameter[reser$parameter=="Smax"]<-"smax"
reser$method[reser$method=="MCMC"]<-"HMC"
resaparam<-reser[reser$parameter%in%c("alpha","smax","smsy","sgen","umsy"),]
...
resaparam$scenario<-factor(resaparam$scenario, levels=c("decLinearProd_highERLowError",
...
mapbias_p_alpha 
ggsave("C:/Users/worc/OneDrive - DFO-MPO/timevar_simeval/summary_stats/senser_median_abs_pct_bias_alpha.png",
...
theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
mapbias_p_smax
ggsave("C:/Users/worc/OneDrive - DFO-MPO/timevar_simeval/summary_stats/senser_median_abs_pct_bias_smax.png",
    plot=mapbias_p_smax)
...
theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
mapbias_p_smsy
ggsave("C:/Users/worc/OneDrive - DFO-MPO/timevar_simeval/summary_stats/senser_median_abs_pct_bias_smsy.png",
    plot=mapbias_p_smsy)
...
theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
mapbias_p_sgen
ggsave("C:/Users/worc/OneDrive - DFO-MPO/timevar_simeval/summary_stats/senser_median_abs_pct_bias_sgen.png",
    plot=mapbias_p_sgen)
...
theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
meancv_alpha_p
ggsave("C:/Users/worc/OneDrive - DFO-MPO/timevar_simeval/summary_stats/senser_mean_by_cv_alpha.png",
    plot=meancv_alpha_p)
...
theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
meancv_smax_p
ggsave("C:/Users/worc/OneDrive - DFO-MPO/timevar_simeval/summary_stats/senser_mean_by_cv_smax.png",
    plot=meancv_smax_p)
...
theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
meancv_smsy_p
ggsave("C:/Users/worc/OneDrive - DFO-MPO/timevar_simeval/summary_stats/senser_mean_by_cv_smsy.png",
    plot=meancv_smsy_p)
...
theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
meancv_sgen_p
ggsave("C:/Users/worc/OneDrive - DFO-MPO/timevar_simeval/summary_stats/senser_mean_by_cv_sgen.png",
    plot=meancv_sgen_p)
...
write.csv(mapbias,file = "C:/Users/worc/OneDrive - DFO-MPO/timevar_simeval/summary_stats/summary_stats_senser.csv", row.names = FALSE)
