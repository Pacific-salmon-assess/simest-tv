...
ranksbaseall$scenario=factor(ranksbaseall$"scns[i]", levels=c("stationary",  "autocorr", "sigmaShift",
 "decLinearProd", "sineProd", "regimeProd", "shiftProd", "regimeCap",  "decLinearCap","shiftCap",
                       "regimeProdCap", "decLinearProdshiftCap" ))

ranksbaseall$parameter=factor(ranksbaseall$"paras[u]", levels=c("alpha","smax","smsy"))

ranksbaseall$paramch<-recode(ranksbaseall$scenario, 
...
ranksbaseall$scnmodmatch[ranksbaseall$scenario %in% c("stationary",  "sigmaShift")&
                        ranksbaseall$model=="simple"]<-1

ranksbaseall$scnmodmatch[ranksbaseall$scenario %in% c( "autocorr")&
                        ranksbaseall$model=="autocorr"]<-1
ranksbaseall$scnmodmatch[ranksbaseall$scenario %in% c("decLinearProd", "sineProd")&
                        ranksbaseall$model=="rwa"]<-1
ranksbaseall$scnmodmatch[ranksbaseall$scenario %in% c("regimeProd", "shiftProd")&
                        ranksbaseall$model=="hmma"]<-1
ranksbaseall$scnmodmatch[ranksbaseall$scenario %in% c("decLinearCap")&
                        ranksbaseall$model=="rwb"]<-1
ranksbaseall$scnmodmatch[ranksbaseall$scenario %in% c("regimeCap", "shiftCap")&
                        ranksbaseall$model=="hmmb"]<-1
ranksbaseall$scnmodmatch[ranksbaseall$scenario %in% c("regimeProdCap")&
                        ranksbaseall$model=="hmmab"]<-1
ranksbaseall$scnmodmatch[ranksbaseall$scenario %in% c( "decLinearProdshiftCap")&
                        ranksbaseall$model=="rwab"]<-1
...
pranks<-ggplot(data=ranksbaseall, aes(x=model, y=average.rank,fill=modtype,color=scnmodmatch ))+
...
pranks
ggsave("../Best-Practices-time-varying-salmon-SR-models/figures/ranks/base_average_rank.png", plot=pranks)
